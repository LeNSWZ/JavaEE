...
public class Employee {
	...
	public String toString() {
		return "Employee [account=" + account + ", wages=" + wages + ", gender=" + gender + ", telphone=" + telphone
				+ ", employeeName=" + employeeName + ", address=" + address + ", idCard=" + idCard + ", email="
				+ email + ", entryTime=" + entryTime + ", separationTime=" + separationTime + ", status=" + status
				+ "]";
	}
